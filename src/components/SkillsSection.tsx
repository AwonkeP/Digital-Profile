  ...
  return (
    <section id="skills" className="pt-10 scroll-mt-20">
      ...
      >
        ...
        <div className="flex flex-wrap gap-1.5 p-1 bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-800 rounded-2xl shadow-sm">
          {filterTabs.map((tab) => {
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-neutral-950 dark:bg-white rounded-xl shadow-sm"
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <span className="px-2.5 py-1 rounded-full bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 text-[11px] font-bold text-neutral-900 dark:text-neutral-100 tracking-wide">
                      {skill.domain}
                    </span>
                  </div>
